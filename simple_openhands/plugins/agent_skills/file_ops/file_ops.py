...
from .._aci.linter import DefaultLinter, LintResult
...
def search_dir(search_term: str, dir_path: str = './') -> None:
    ...
    for file_path, line_num, line in matches:
        # Convert to POSIX format for consistent output across platforms
        print(f'{file_path.replace(os.sep, "/")} (Line {line_num}): {line}')
