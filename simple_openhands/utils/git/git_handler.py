...
from simple_openhands.utils.git import git_changes, git_diff

GIT_CHANGES_CMD = 'python3 /simple_openhands/code/simple_openhands/utils/git/git_changes.py'
GIT_DIFF_CMD = (
    'python3 /simple_openhands/code/simple_openhands/utils/git/git_diff.py "{file_path}"'
)
