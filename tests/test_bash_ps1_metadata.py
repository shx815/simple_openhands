...
###PS1JSON###
{
  ...
  "username": "testuser",
  "hostname": "testhost",
  "working_dir": "/home/testuser/work/test-project",
  "py_interpreter_path": "/home/testuser/.cache/pypoetry/virtualenvs/test-project-abc123-py3.12/bin/python"
}
###PS1END###
"""
    matches = CmdOutputMetadata.matches_ps1_metadata(ps1_str)
    ...
    assert metadata.working_dir == '/home/testuser/work/test-project'
    assert (
        metadata.py_interpreter_path
        == '/home/testuser/.cache/pypoetry/virtualenvs/test-project-abc123-py3.12/bin/python'
    )
